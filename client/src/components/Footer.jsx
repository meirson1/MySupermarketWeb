...
import { AiFillPhone,AiFillFacebook,AiFillPrinter,AiFillHome,AiFillMail} from "react-icons/ai";
    ...
    <section className="footer">
      <section className="footer-info">
        ...
        <div className='me-5 d-none d-lg-block'>
          ...
          <br />
          <a href="https://www.facebook.com/My-Supermarket-109443241883186" className='me-4 text-reset'>
